...
//  VoiceInput
//
//  Created by maochun on 2021/5/30.
//
...
class ViewController: UIViewController {
    ...
    lazy var btnStart : UIButton = {
        ...
        b.addTarget(self, action: #selector(btnStartSpeechToText), for: .touchUpInside)
        b.translatesAutoresizingMaskIntoConstraints = false
        self.view.addSubview(b)
        
        NSLayoutConstraint.activate([
            b.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: 100),
